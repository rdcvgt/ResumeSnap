...
export default function ECActivities({
	...
	const blockTitle = blockData.content.blockTitle || "ECActivities";
	...
	return (
		<BlockContainer>
			<TitleBlock
				...
				handleDeleteButtonClick={() => {
					handleDeleteButtonClick(blockId, "ECActivities");
				}}
			...
			<DragDropContext onDragEnd={handleOnDragEnd}>
				<Droppable droppableId="ECActivitiesItems">
					{(provided) => (
						<div
			...
			<AddItemButton onClick={handleAddItemButtonClick}>
				...
				<AddItemText>Add one more activity</AddItemText>
			</AddItemButton>
		</BlockContainer>
	);
}
