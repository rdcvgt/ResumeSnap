...
export default function Internships({
	...
	const blockTitle = blockData.content.blockTitle || "Internships";
	...
	return (
		<BlockContainer>
			<TitleBlock
				...
				handleDeleteButtonClick={() => {
					handleDeleteButtonClick(blockId, "Internships");
				}}
			...
			<DragDropContext onDragEnd={handleOnDragEnd}>
				<Droppable droppableId="InternshipsItems">
					{(provided) => (
						<div
			...
			<AddItemButton onClick={handleAddItemButtonClick}>
				...
				<AddItemText>Add one more internship</AddItemText>
			</AddItemButton>
		</BlockContainer>
	);
}
