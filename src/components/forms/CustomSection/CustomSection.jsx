...
export default function CustomSection({
	...
	const blockTitle = blockData.content.blockTitle || "CustomSection";
	...
	return (
		<BlockContainer>
			<TitleBlock
				...
				handleDeleteButtonClick={() => {
					handleDeleteButtonClick(blockId, "CustomSection");
				}}
			...
			<DragDropContext onDragEnd={handleOnDragEnd}>
				<Droppable droppableId="CustomSectionItems">
					{(provided) => (
						<div
			...
			<AddItemButton onClick={handleAddItemButtonClick}>
				...
				<AddItemText>Add one more item</AddItemText>
			</AddItemButton>
		</BlockContainer>
	);
}
